...
_sage_const_10555 = Integer(10555); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_100 = Integer(100); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2)
from ptrlib import Socket
import ast
import re

sock = Socket("localhost", _sage_const_10555 )
_ = sock.recvline()
line = sock.recvline().decode()
p, M = re.findall(r"p: (\d+), and M: (.+)", line)[_sage_const_0 ]
p = int(p)
F = GF(p)
